  ...
  <div class="wrap">
    <div class="perf-2">
      <div class="sr">
        ...
        <h2 class="h2">UNA HISTORIA<br>QUE EMPIEZA EN CÓRDOBA</h2>
      </div>
      <div class="sr">
        <p class="bod" style="margin-bottom:18px"><em>[Pendiente: contar el origen de EMAT. Cuándo arrancaron, quiénes son los fundadores, qué problema vieron en el mercado y por qué decidieron resolverlo con celulosa reciclada.]</em></p>
        <p class="bod" style="margin-bottom:18px"><em>[Pendiente: la transición de "tener una idea" a "tener una empresa". Hitos importantes, primeros clientes, primeras obras grandes.]</em></p>
        <p class="bod"><em>[Pendiente: dónde están parados hoy y hacia dónde van.]</em></p>
      </div>
    </div>
  </div>
</section>
...
<section class="sec" style="background:var(--n1)">
  <div class="wrap">
    <div class="bs-head sr">
      <div class="lbl">Propósito</div>
      <h2 class="h2">CONSTRUIMOS PARA QUE SE VIVA MEJOR</h2>
      <p><em>[Pendiente: la frase que resume el "para qué" de EMAT. ¿Qué impacto buscan generar más allá del producto? Salud, sustentabilidad, economía circular, desarrollo local.]</em></p>
    </div>
    <div class="bs-g sr">
      <div class="bs-c">
        <div class="bs-ico"><svg viewBox="0 0 24 24"><path d="M12 2v20M2 12h20"/></svg></div>
        <div><h3>Misión</h3><p><em>[Pendiente: misión de la empresa en una o dos oraciones.]</em></p></div>
      </div>
      <div class="bs-c">
        <div class="bs-ico"><svg viewBox="0 0 24 24"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg></div>
        <div><h3>Visión</h3><p><em>[Pendiente: hacia dónde quiere llegar EMAT en los próximos años.]</em></p></div>
      </div>
      <div class="bs-c">
        <div class="bs-ico"><svg viewBox="0 0 24 24"><path d="M20.84 4.61a5.5 5.5 0 00-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 00-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 000-7.78z"/></svg></div>
        <div><h3>Valores</h3><p><em>[Pendiente: 3 a 5 valores que guían las decisiones (ej: sustentabilidad real, calidad técnica, transparencia, desarrollo local).]</em></p></div>
      </div>
      <div class="bs-c">
        ...
        <div><h3>Compromiso ambiental</h3><p><em>[Pendiente: cómo se traduce el compromiso ambiental en acciones concretas. Más del 80% reciclado, producción local, etc.]</em></p></div>
      </div>
    </div>
  </div>
</section>
...
<section class="sec" id="equipo">
  <div class="wrap">
    <div class="sec-hdr sr">
      <div><div class="lbl">El equipo</div><h2 class="h2" style="margin-bottom:0">QUIÉNES HACEN EMAT</h2></div>
    </div>
    <div class="prods-3 sr">
      <div class="pc">
        <div class="pc-img pi-g" style="background:linear-gradient(145deg,var(--g4),var(--g2))"><svg viewBox="0 0 24 24"><path d="M20 21v-2a4 4 0 00-4-4H8a4 4 0 00-4 4v2"/><circle cx="12" cy="7" r="4"/></svg></div>
        <div class="pc-body"><h3>[Nombre]</h3><span class="pc-sub">[Rol]</span><p><em>[Pendiente: bio breve, formación, qué hace dentro del equipo, qué le apasiona del proyecto.]</em></p></div>
      </div>
      <div class="pc">
        <div class="pc-img pi-dg"><svg viewBox="0 0 24 24"><path d="M20 21v-2a4 4 0 00-4-4H8a4 4 0 00-4 4v2"/><circle cx="12" cy="7" r="4"/></svg></div>
        <div class="pc-body"><h3>[Nombre]</h3><span class="pc-sub">[Rol]</span><p><em>[Pendiente: bio breve, formación, qué hace dentro del equipo, qué le apasiona del proyecto.]</em></p></div>
      </div>
      <div class="pc">
        <div class="pc-img pi-dk"><svg viewBox="0 0 24 24"><path d="M20 21v-2a4 4 0 00-4-4H8a4 4 0 00-4 4v2"/><circle cx="12" cy="7" r="4"/></svg></div>
        <div class="pc-body"><h3>[Nombre]</h3><span class="pc-sub">[Rol]</span><p><em>[Pendiente: bio breve, formación, qué hace dentro del equipo, qué le apasiona del proyecto.]</em></p></div>
      </div>
    </div>
    <p class="bod sr" style="text-align:center;margin-top:32px;color:var(--n4);font-style:italic">Pendiente: foto profesional del equipo y datos de contacto/LinkedIn por persona.</p>
  </div>
</section>

<!-- Hitos -->
<section class="sec" style="background:var(--g5);color:var(--n0)">
  <div class="wrap">
    <div class="sec-hdr sr">
      <div><div class="lbl lbl-w">Recorrido</div><h2 class="h2 h2-w" style="margin-bottom:0">HITOS QUE NOS DEFINEN</h2></div>
    </div>
    <div class="stats-g sr" style="margin-top:40px">
      <div class="st"><div class="n">[año]</div><div class="l" style="color:rgba(255,255,255,.6)">Fundación de EMAT</div></div>
      <div class="st"><div class="n">+500</div><div class="l" style="color:rgba(255,255,255,.6)">Proyectos realizados</div></div>
      <div class="st"><div class="n">[X]</div><div class="l" style="color:rgba(255,255,255,.6)">Toneladas recicladas</div></div>
      <div class="st"><div class="n">[X]</div><div class="l" style="color:rgba(255,255,255,.6)">Personas en el equipo</div></div>
    </div>
    <p class="bod bod-w sr" style="text-align:center;margin-top:32px;opacity:.7;font-style:italic">Pendiente: actualizar números con datos reales.</p>
  </div>
</section>
...
pages = [
    ...
    },
    {
        ...
        "title": "Quiénes somos — EMAT, aislación sustentable desde Córdoba",
        "description": "Conocé al equipo detrás de EMAT: nuestra historia, propósito y compromiso con la construcción sustentable y la economía circular en Argentina.",
        ...
        "hero": page_hero(
            "Nuestra historia",
            "Quiénes somos<br><span class='accent'>y por qué hacemos esto</span>",
            "Una empresa cordobesa que produce aislación de celulosa reciclada con un propósito claro: que la construcción sea más eficiente, más saludable y más sustentable.",
            cta_label="Conocer al equipo",
            cta_href="#equipo",
            cta2_label="Ver nuestra historia",
            cta2_href="#historia",
